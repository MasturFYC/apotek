...
const CustomerForm = ({ customer: cust, options }: CustomerFormType) => {
  ...
  // }, [cust])
  return (
    <form className={'form-floating border row g-3 m-0 pb-3'} >
      ...
      <div className={'col-md-6 form-floating mb-1'}>
        ...
        <label htmlFor={'txt-name'} className={'mx-2 col-form-label-sm'}>Nama Pelanggan</label>
      </div>
      ...
      <div className={'col-md-6 form-floating mb-1'}>
        ...
        <label htmlFor={'txt-address'} className={'mx-2 col-form-label-sm'}>Alamat</label>
      </div>
      ...
      <div className={'col-md-6 form-floating mb-1'}>
        ...
        <label htmlFor={'txt-city'} className={'mx-2 col-form-label-sm'}>Kota</label>
      </div>
      ...
      <div className={'col-md-6 form-floating mb-1'}>
        ...
        <label htmlFor={'txt-zip'} className={'mx-2 col-form-label-sm'}>Kode Pos</label>
      </div>
      ...
      <div className={'col-md-6 form-floating mb-1'}>
        ...
        <label htmlFor={'txt-phone'} className={'mx-2 col-form-label-sm'}>Telephone</label>
      </div>
      ...
      <div className={'col-md-6 form-floating mb-1'}>
        ...
        <label htmlFor={'txt-cell'} className={'mx-2 col-form-label-sm'}>Cellular</label>
      ...
      <div className={'col-md-6 form-floating mb-1'}>
        ...
        <label htmlFor={'txt-credit'} className={'mx-2 col-form-label-sm'}>Limit Credit</label>
      ...
      <div className={'col-md-10 form-floating mb-1'}>
        ...
        <label htmlFor={'txt-desc'} className={'mx-2 col-form-label-sm'}>Keterangan</label>
      </div>
