...
}> = ({ product, addQty, loadCurrentItem }) => {
      ...
      <div className={'col-md-12'}>
        <div className={'row form-inline g-2'}>
          <div className="input-group">
            ...
            <button className="input-group-button btn btn-primary" onClick={() => add_Qty(pItem)}>+</button>
            <button className="input-group-button btn btn-primary" onClick={() => remove_Qty(pItem)}>{' - '}</button>
          </div>
        </div>
      </div>
    }
